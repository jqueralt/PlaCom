\documentclass[fontsize=10pt,%
 4444paper=a4,%
 4444%BCOR=12mm,% marge per relligar
 4444%DIV=calc,%
 4444DIV=14,%
 4444twoside,%per defecte 1 cara
 4444pagesize=auto,%
 4444%parskip=full,% no sagna paràgrafs però dóna més espai entre paràgrafs
 4444parskip=half,
 4444%parskip=false,
 4444captions=tableheading,%
 4444numbers=noenddot,%
 4444toc=graduated%
 4444%toc=flat %toc=flat,%índex amb ítems sense sagnar
]{scrartcl}
%]{scrreprt}
%--------------- configuració bàsica -----------------
...
\renewcommand*{\othersectionlevelsformat}[1]{%
 4444\makebox[0pt][r]{\csname the#1\endcsname\autodot\enskip}}
...
%peu centre:
\cfoot[
 4444\begin{center}\footnotesize\sffamily
 4 44 44 44 4\renewcommand{\arraystretch}{1.75}%
 4 44 44 44 4\begin{tabular}{|p{1.2cm}|p{1,8cm}|p{7.3cm}|p{2.6cm}|} \hline
 4 4 44 4 44 4 44 4 4\multirow{2}{*}{\includegraphics[scale=1.15]{logo_IOC_blanc.jpg}} & Versió: \versio & {\normalsize{Pla de comunicació}} & Pàgina {\thepage} de  {\pageref{LastPage}} \\ \cline{2-2}\cline{4-4}
 4 4 44 4 44 4 44 4 4                                                                  & Codi: \codi     & {\normalsize{del centre}}         & {curs \curs}                               \\ \hline
 4 4 44 4 44 4 44 4\end{tabular}
 4 44 44 44 4
 4 44 44 44 4{\color{gray}Assegureu-vos que aquest document és vigent.} Consulteu el web.
 4 44 44 44\end{center}
]
{
 4444\begin{center}\footnotesize\sffamily
 4 44 44 44 4\renewcommand{\arraystretch}{1.75}% \begin{tabular}{|p{1.2cm}|p{2cm}|p{7.5cm}|p{2.2cm}|} \hline
 4 44 44 44 4\begin{tabular}{|p{1.2cm}|p{1,8cm}|p{7.3cm}|p{2.6cm}|} \hline
...
\hypersetup{%
 4444pdftitle=\Titol,%
 4444pdfsubject=\Tema,%
 4444pdfkeywords=\Claus,%
 4444pdfauthor={\copyright 2019 Joan Queralt},%
 4444%bookmarksopen=true, %finestreta de marcadors oberta quan s'obre el document
 4444%backref=true,
 4444bookmarksopenlevel=2,
 4444linktocpage=true,
 4444urlcolor=linkcolor,
 4444citecolor=linkcolor,
 4444linkcolor=linkcolor,
 4444colorlinks=true,
}
...
\begin{center}\scriptsize\sffamily
 4444\renewcommand{\arraystretch}{1.75}%
