\documentclass[fontsize=10pt,%
 4paper=a4,%
 4%BCOR=12mm,% marge per relligar
 4%DIV=calc,%
 4DIV=14,%
 4twoside,%per defecte 1 cara
 4pagesize=auto,%
 4%parskip=full,% no sagna paràgrafs però dóna més espai entre paràgrafs
 4parskip=half,
 4%parskip=false,
 4captions=tableheading,%
 4numbers=noenddot,%
 4toc=graduated%
 4%toc=flat %toc=flat,%índex amb ítems sense sagnar
]{scrartcl}
%]{scrreprt}
%--------------- configuració bàsica -----------------
...
\renewcommand*{\othersectionlevelsformat}[1]{%
 4\makebox[0pt][r]{\csname the#1\endcsname\autodot\enskip}}
...
%peu centre:
\cfoot[
 4\begin{center}\footnotesize\sffamily
 4 4\renewcommand{\arraystretch}{1.75}%
 4 4\begin{tabular}{|p{1.2cm}|p{1,8cm}|p{7.3cm}|p{2.6cm}|} \hline
 4 4 4\multirow{2}{*}{\includegraphics[scale=1.15]{logo_IOC_blanc.jpg}} & Versió: \versio & {\normalsize{Pla de comunicació}} & Pàgina {\thepage} de  {\pageref{LastPage}} \\ \cline{2-2}\cline{4-4}
 4 4 4                                                                  & Codi: \codi     & {\normalsize{del centre}}         & {curs \curs}                               \\ \hline
 4 4\end{tabular}
 4 4
 4 4{\color{gray}Assegureu-vos que aquest document és vigent.} Consulteu el web.
 4\end{center}
]
{
 4\begin{center}\footnotesize\sffamily
 4 4\renewcommand{\arraystretch}{1.75}% \begin{tabular}{|p{1.2cm}|p{2cm}|p{7.5cm}|p{2.2cm}|} \hline
 4 4\begin{tabular}{|p{1.2cm}|p{1,8cm}|p{7.3cm}|p{2.6cm}|} \hline
...
\hypersetup{%
 ...
 4pdfsubject=\Tema,%
 4pdfkeywords=\Claus,%
 4pdfauthor={\copyright 2019 Joan Queralt},%
 4%bookmarksopen=true, %finestreta de marcadors oberta quan s'obre el document
 4%backref=true,
 4bookmarksopenlevel=2,
 4linktocpage=true,
 4urlcolor=linkcolor,
 4citecolor=linkcolor,
 4linkcolor=linkcolor,
 4colorlinks=true,
}
...
\begin{center}\scriptsize\sffamily
 4\renewcommand{\arraystretch}{1.75}%
