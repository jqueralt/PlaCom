...
%DIV=calc,%
DIV=14,%
twoside=semi,%per defecte 1 cara
pagesize=auto,%
...
\usepackage[automark,
headsepline=.4pt]{scrlayer-scrpage} %automark posa automàticament la marca que correspon
...
\addtokomafont{pagehead}{\color{lightgray}}	% dóna color gris al text de la capçalera
\setlength{\footheight}{55pt}%55
...
\begin{tabular}{|p{1.2cm}|p{1,8cm}|p{7.5cm}|p{2.6cm}|} \hline
\multirow{2}{*}{\includegraphics[scale=1.15]{logo_IOC_blanc.jpg}} & Versió: \versio & {\normalsize{Pla de comunicació}} & Pàgina {\pagemark} de  {\pageref{LastPage}} \\ \cline{2-2}\cline{4-4} & Codi: \codi     & {\normalsize{del centre}}         & {curs \curs}\\ \hline
\end{tabular}
...
%% https://tex.stackexchange.com/questions/413652/scrlayer-scrpage-with-pagestyleempty

%\BeforeStartingTOC[toc]{\pagestyle{empty}}
\AfterStartingTOC{\thispagestyle{plain}}% settings for the last page of TOC, LOF, LOT etc.
...
\pdfstringdef{\Claus}{Pla, comunicació, programació, IOC, responsables, tasques}%
